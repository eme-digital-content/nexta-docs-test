...
After you [create a record](/api-documentation/create-profile.mdx), you can update the registered data through **My Staff API**. Follow the steps explained below.
...
Done. Yoou record has been updated with the new data.
