...
**My Staff API** provides you all the available endpoints to manage your employee records via HTTP Request.
...
[Go to API Documentation](https://documenter.getpostman.com/view/36433185/2sA3XV8zGt)
