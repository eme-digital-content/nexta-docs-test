...
![Settings icon](/images/prints-ui/settings.png)

3. In the **Settings** page, scroll down to the end of the form.

![Settings page](/images/prints-ui/delete-all/delete-all-content.png)
...
![Delete all confirmation](/images/prints-ui/delete-all/delete-all-content-modal.png)
