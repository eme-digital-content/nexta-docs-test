...
![Right-click deletion menu](/images/prints-ui/delete-post/delete-right-click.png)

5. It opens a modal confirming that you want to delete the post. Click the **Delete** button.

![Confirm delete modal](/images/prints-ui/delete-post/confirm-delete.png)
...
![Content editor deletion button](/images/prints-ui/delete-post/editor-delete.png)
