...
You can create a new post any time you want. To do so, follow this steps:
...
3. In the content editor, add everything you need to create your post:
   ...
   ![Content editor](/images/prints-ui/publish-post/new-post.png)

4. Then, click the **Settings** icon, locating in the upper right corner.
...
Done! Now your new post is published!
