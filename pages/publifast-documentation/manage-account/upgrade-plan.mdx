...
![Upgrade plan button](/images/prints-ui/upgrade-plan/updgrade-button.png)

3. In the **Plans** page, click the **Choose this plan** button of the plan you want to select.

![Plans page](/images/prints-ui/upgrade-plan/upgrade-plans.png)

4. Complete the **Payment** form as required.

![Payment form](/images/prints-ui/upgrade-plan/plans-payment.png)
