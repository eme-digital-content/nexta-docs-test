...
- The project include a few guides with content. These guides are marked with the **memo emoji** (📝). The rest of the files are empty and were created just to get a better presentation.
